        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <img id="image1" width='250' height='350' border='1' style="border: 1px solid #000">
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <a href="/generate/print">MAKE CHANGES</a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <a href="/generate/print?clear=now">START A NEW IMAGE</a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <a href="/list">LIST ON ETSY</a>
                    </div>
                  </div>
...
<script>
  ...
  function handleImagePathResults(response) {
    if(response.length < 3) {
      ...
      console.log(response[0].imagePath+""+response[0].imageName);
      $("#message").empty();
      $("#message").html("Images created and loading...");
      $("#image1").attr("src", response[0].imagePath+""+response[0].imageName);
    }
  }
</script>
@stop
