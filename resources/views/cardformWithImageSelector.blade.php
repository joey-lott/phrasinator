...
<div class="container">
    <div class="row">
      ...
      ?>
      @endforeach
      <form method="post" action="/generate/print">
        {{csrf_field()}}
        ...
        <div class="row form-group">
          <label class="form-group col-md-2">Border:</label>
          <div class="col-md-1">
            <input type="checkbox" name="border" class="form-control" @if($border != null) checked @endif>
          </div>
          <div class="col-md-3">
            <input class="jscolor" name="borderColor" value="{{$borderColor}}">
          </div>
          <div class="col-md-6">
            <input type="range" min="10" max="100" default="30" name="borderWidth" value="{{$borderWidth}}">
          </div>
        </div>
